...
| [`testing.md`](./testing.md)                                 | Unit-test coverage targets, scope, the PR-comment workflow, how to update thresholds, and the Playwright-BDD `data-testid` selector rule.                                                                               |
